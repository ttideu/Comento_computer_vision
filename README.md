...
ONNX FP32 변환 후에도 Test Accuracy **87.6%**를 유지했습니다. 동일 환경의 CPU 추론 벤치마크에서는 PyTorch FP32 중앙값 **6.7009 ms**, ONNX Runtime FP32 **1.3187 ms**로 측정되어 약 **5.08×** 빠른 추론 시간을 확인했습니다.

INT8 정적 양자화도 실험했지만 Test Accuracy가 **11.2%**까지 하락해 최종 적용에서 제외했습니다. 실패 결과를 숨기기보다 정확도 손실을 확인한 뒤 FP32 모델을 유지하는 방향으로 결정했습니다.
